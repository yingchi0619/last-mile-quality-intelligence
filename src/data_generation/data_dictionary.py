...
FIELDS = [
    ...
    ("routes", "route_id", "string", "Unique daily route assignment identifier", "R000001"),
    ("routes", "route_line_id", "string", "Stable fictional station route line identifier", "EWR01-L01"),
    ...
    ("routes", "planned_pickup_timestamp", "timestamp", "Scheduled route pickup timestamp", "2026-01-06 08:00:00"),
    ("routes", "actual_pickup_timestamp", "timestamp", "Actual route pickup timestamp after driver/station delay", "2026-01-06 08:37:00"),
