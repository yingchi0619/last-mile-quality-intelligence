...
FIELDS = [
    ("stations", "station_id", "string", "Unique fictional station identifier", "STN_A"),
    ("stations", "station_name", "string", "Fictional station display name", "Aurora Node"),
    ...
    ("delivery_service_providers", "provider_id", "string", "Unique fictional provider identifier", "DSP_ALPHA"),
    ("delivery_service_providers", "provider_name", "string", "Fictional provider display name", "Alpha Fleet Collective"),
    ...
    ("drivers", "provider_id", "string", "Provider employing the synthetic driver", "DSP_ALPHA"),
    ...
    ("routes", "service_date", "date", "Synthetic route operating date", "2025-01-06"),
    ("routes", "station_id", "string", "Origin station identifier", "STN_A"),
    ("routes", "provider_id", "string", "Assigned provider identifier", "DSP_ALPHA"),
    ...
    ("deliveries", "service_date", "date", "Synthetic service date", "2025-01-06"),
    ("deliveries", "pickup_timestamp", "timestamp", "Synthetic package pickup timestamp", "2025-01-06 08:12:00"),
    ("deliveries", "delivery_timestamp", "timestamp", "Synthetic delivery or final-attempt timestamp", "2025-01-06 14:26:00"),
